            ...
            <div className={message.length < 1 ? "pt-10" : "pt-2"}>
                {
                  ...
                  :
                  <button type="submit" className="w-full flex justify-center bg-[#0B3B36] text-gray-100 p-3 rounded-lg tracking-wide font-semibold cursor-pointer" onClick={(e) => {handleDaftar(e)}}>
                  Daftar
                  </button>
                }
            </div>
        </form>
        <p className="text-sm pt-10">Sudah memiliki akun? <Link to="/login"><span className="text-[#0B3B36] font-[600] cursor-pointer">Masuk</span></Link></p>
      </div>
  </div>
  )
}
