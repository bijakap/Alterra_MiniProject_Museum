...
const CustomInput = ({label, value, setValue, optional, placeholder, name, type, regex}) => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <input className="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#0A6C62] mt-2 mb-6" value={value[name]} placeholder={placeholder} type={type} name={name} onChange={(e) => {HandelChange(e,regex)}} />
    </div>
  )
}
