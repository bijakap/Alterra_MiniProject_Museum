  ...
  return (
    <div className="w-full shadow-md">
      <div className={role === true ? "hidden" : "py-10 px-9 bg-[#0A6C62] text-white"}>
        <p className="text-[22px] font-bold mb-[10px]">YourLogo</p>
        <p className="w-[430px] text-justify">“YourLogo” adalah platform berbagi pengalaman tempat wisata museum, pengguna dapat menambahkan ulasan terkait tempat wisata, sehingga pengguna lain dapat melihat pengalaman dari pengguna lainnya</p>
      </div>
